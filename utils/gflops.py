...
# ImageNet-LT
# ResNeXt50
# python -m utils.gflops ResNeXt50 0 --num_experts 4 --reduce_dim True --use_norm False

# iNaturalist
## LDAM
# python -m utils.gflops ResNet50 1 --num_experts 3 --reduce_dim True --use_norm True

# Imbalance CIFAR 100
## LDAM
# python -m utils.gflops ResNet32 2 --num_experts 3 --reduce_dim True --use_norm True
